package com.yijiajiao.finance.aop;
...
public class ExceptionAspect {
      ...
      */
     @Around("execution(public com.yijiajiao.finance.bean.ResultMapper com.yijiajiao.finance.service.*.*(..))")
     public ResultMapper aroundMethod(ProceedingJoinPoint pjd) {
         ...
         try {
             ...
             result = (ResultMapper) pjd.proceed();
             //返回通知 
